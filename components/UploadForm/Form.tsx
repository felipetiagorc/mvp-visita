          ...
          <div className="rounded-lg shadow-xl bg-gray-50 lg:w-1/2">
            <div className="flex justify-center p-2 space-x-2 ">
              <div className="flex justify-center p-2 space-x-2 ">
                <label
                  htmlFor="myFileInput"
                  className="flex flex-col space-2 p-2 m-3 text-white bg-blue-500 rounded shadow-xl transition ease-in-out delay-50 hover:-translate-y-1 hover:scale-100 hover:bg-blue-600 duration-200"
                >
                  <svg
